...
export const STATUS_MESSAGES = {
    ...
    PLANET_MINE_SUCCESS: (amount: number, unitName: string, current: number, capacity: number) => `Mined ${amount.toFixed(1)} m^3 of ${unitName}. (${current.toFixed(1)}/${capacity} m^3)`, // [cite: 486]
