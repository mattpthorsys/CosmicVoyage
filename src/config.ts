...
export const CONFIG = {
  ...
  STARTING_HUB_OFFSET_X: 1,
  STARTING_HUB_OFFSET_Y: 0,
  PLAYER_CHAR: '@',
  ...
  KEY_BINDINGS: {
    ...
    MOVE_UP_LEFT: 'Numpad7',
    MOVE_UP_RIGHT: 'Numpad9',
    MOVE_DOWN_LEFT: 'Numpad1',
    MOVE_DOWN_RIGHT: 'Numpad3',
    FINE_CONTROL: 'Shift',
    BOOST: 'Control',
    PAGE_UP: 'PageUp',
    PAGE_DOWN: 'PageDown',
  ...
  CORE_SETTLEMENT_DENSITY_MULTIPLIER: 5,
  ...
  // --- Astrometric Overlay ---
  ASTROMETRIC_OVERLAY_EMIT_MS: 4600,
  ASTROMETRIC_OVERLAY_DURATION_MS: 4600,
  ASTROMETRIC_OVERLAY_FADE_MS: 1400,
  ASTROMETRIC_OVERLAY_LINE_DRAW_MS: 320,
  ASTROMETRIC_OVERLAY_TYPE_SPEED: 95,
  ASTROMETRIC_OVERLAY_MAX_ITEMS: 3,
