...
export const CONFIG = {
    ...
    CHAR_ASPECT_RATIO: 8 / 8, // Assuming square chars simplifies things
    CHAR_SCALE: 2, // Scales the base font size
    FONT_SIZE_PX: 8, // Base size in pixels
    FONT_FAMILY: '"Courier New", Courier, monospace',

    // --- Colours --- (Using Australian spelling based on your preference)
    ...
    SYSTEM_MOVE_INCREMENT_FACTOR: 50, // Multiplier for player movement speed in system
    ...
    STARBASE_ORBIT_DISTANCE: 75000, // Base orbit distance for starbases (was 7500, increased for scale)

    // --- Planet Surface ---
    PLANET_MAP_BASE_SIZE: 256, // Target size for heightmap generation (will be power of 2 + 1)
    ...
    PLANET_HEIGHT_LEVELS: 256, // Number of distinct altitude levels
    MINING_RATE_FACTOR: 5, // Base number of minerals mined per action
    ...
    HYPERSPACE_FUEL_COST: 10, // Fuel cost to jump between systems (currently not implemented)
    SYSTEM_MOVE_FUEL_COST: 0.0, // Fuel cost per move step within a system
    ...
    // --- Input Keys --- (Using KeyboardEvent.key values)
    KEY_UP: 'ArrowUp',
    KEY_DOWN: 'ArrowDown',
    KEY_LEFT: 'ArrowLeft',
    ...
    KEY_TRADE: 't',
    KEY_REFUEL: 'r',
    FINE_CONTROL_FACTOR: 0.1, // Speed reduction factor when holding Shift (or other modifier)
    ...
    // --- Movement / Physics ---
    SYSTEM_MOVE_INCREMENT: 5000, // World units per key press in system view (adjust as needed)
    SYSTEM_ORBIT_SPEED_FACTOR: 0.05, // How fast planets orbit (adjust speed)
    LANDING_DISTANCE: 10000, // Max distance from planet/starbase to allow landing action
    
    // --- Input Keys --- (Example key bindings - using KeyboardEvent.key values)
    KEY_BINDINGS: {
        MOVE_UP: 'ArrowUp',
        MOVE_DOWN: 'ArrowDown',
        MOVE_LEFT: 'ArrowLeft',
        MOVE_RIGHT: 'ArrowRight',
        // Diagonal movement keys (optional - map multiple keys in InputManager)
        MOVE_UP_LEFT: 'Home', // Example
        MOVE_UP_RIGHT: 'PageUp', // Example
        MOVE_DOWN_LEFT: 'End', // Example
        MOVE_DOWN_RIGHT: 'PageDown', // Example
        // Actions
        ENTER_SYSTEM: 'Enter', // Or 'e' etc.
        LEAVE_SYSTEM: 'Backspace', // Or 'h' for hyperspace etc.
        LAND: 'l', // Landing
        LIFTOFF: 'l', // Liftoff (same key often used)
        SCAN: 'v',
        MINE: 'm',
        TRADE: 't',
        REFUEL: 'r',
        QUIT: 'Escape',
        // Modifiers (handle these separately in InputManager)
        // FINE_CONTROL: 'Shift',
    },
};